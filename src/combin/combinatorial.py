...
def comb_to_rank(
	...
	Returns:
	  integer ranks of the combinations.
	...
	assert (
		colex_order or n is not None
	), "Set cardinality 'n' must be supplied for lexicographical ranking."  # note we need n for colex too!
